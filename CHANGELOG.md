...
- **Motion profiles retuned to exact 2x ratio** — SLOW (accel_x/y/z 300/400/100, jerk 1.5/2.5/0.1, accel_default 300) → MID (600/800/200, 3/5/0.2, 600) → FAST (1200/1600/400, 6/10/0.4, 1200). Earlier values had non-uniform spacing (FAST was 1.67x MID on accel_x, 1.5x on accel_y); halving/doubling around the operator-validated MID anchor makes the per-profile difference obvious on the bench and predictable when tuning per-leg feedrates inside these caps. ADR 0003 example block updated to match.
